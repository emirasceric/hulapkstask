function Reviews() {
  return (
    <div className="emir relative z-1 -mt-4 flex justify-center  items-center   bg-gray-100 py-12">
      <div className="w-full max-w-5xl mx-auto text-center px-4">
        ...
        <p className="text-center text-[25px] leading-[42px] font-bold tracking-[0px] text-[#002D33] font-chronicle mb-8">

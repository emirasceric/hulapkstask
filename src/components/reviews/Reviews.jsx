...
function Reviews() {
  ...
  // Array of reviews with text and author
  const reviews = [
    {
  ...
  return (
    <div className="relative z-1 -mt-4 mb-16 flex justify-center items-center bg-gray-100 py-12">
      ...
      <div className="w-full max-w-5xl mx-auto text-center px-4">
        ...
        {/* Pagination dots to switch between reviews */}
        <div className="flex justify-center items-center space-x-2 mt-8">
          {reviews.map((_, index) => (
            <span
              key={index}
              onClick={() => setActiveReview(index)} // On click, set the active review to the clicked one

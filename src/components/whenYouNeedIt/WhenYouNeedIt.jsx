...
function WhenYouNeedIt() {
  return (
    <div className="emir relative ml-[1%] mr-[1%] flex justify-between items-center mt-16"> 
      
      <div className="w-[31%] h-[415px] rounded-tr-[3%] rounded-br-[3%] overflow-hidden group">
        <div
      ...
      <div className="w-[34%] h-[415px] rounded-[15px] overflow-hidden group flex flex-col justify-center items-center">
        ...
        <div className="absolute top-18 flex flex-col items-center">
          ...
          <p className="text-center font-black font-chronicle text-[78px] leading-[82px] tracking-[-0.78px] text-[#ffffff] ">
            when you <br/> need it.
          </p>
      ...
      <div className="w-[31%] h-[415px] rounded-tl-[15px] rounded-bl-[15px] overflow-hidden group">
        <div
          className="w-full h-full bg-cover bg-no-repeat bg-center transition-transform duration-500 ease-in-out transform group-hover:scale-105"
          style={{
